# Generated by Django 4.2.2 on 2023-07-26 04:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_courses', models.ManyToManyField(blank=True, related_name='all_courses', to='backend.course')),
                ('current_courses', models.ManyToManyField(blank=True, related_name='current_courses', to='backend.course')),
            ],
            options={
                'verbose_name': 'user',
